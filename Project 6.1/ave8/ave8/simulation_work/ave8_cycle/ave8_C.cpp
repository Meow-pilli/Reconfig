...
checksum : 00005bbc90a36daab5fc1e35a6b2cb817e939bea3b43f8a6
...
ave8::CysimRegUpdate_CLOCK_pos_RESET_pos_Async()
{
    ...
    if(RESET.read()) {
        ...
        M_14 = (CYSIM_MASK32(9) & (RG_buffer_4 + RG_buffer_5)); // ../../ave8_sw.c:28,39 OPR_OUT_WIDTH:9
        M_16 = (CYSIM_MASK32(9) & (RG_buffer_2 + RG_buffer_3)); // ../../ave8_sw.c:28,39 OPR_OUT_WIDTH:9
        M_17 = (CYSIM_MASK32(9) & (RG_buffer + RG_buffer_1)); // ../../ave8_sw.c:28,39 OPR_OUT_WIDTH:9
        ...
        M_15 = (CYSIM_MASK32(9) & (RG_buffer_6 + in0.read().to_uint())); // ../../ave8_sw.c:28,35,39 OPR_OUT_WIDTH:9
        sum1_t = (CYSIM_MASK32(11) & (M_121_t + M_15)); // ../../ave8_sw.c:28,35,39 OPR_OUT_WIDTH:11
        ave8_ret_r = (sum1_t >> 3); // ../../ave8_sw.c:43,46
        RG_buffer_6 = RG_buffer_5; // ../../ave8_sw.c:28
        RG_buffer_5 = RG_buffer_4; // ../../ave8_sw.c:28
        RG_buffer_4 = RG_buffer_3; // ../../ave8_sw.c:28
        RG_buffer_3 = RG_buffer_2; // ../../ave8_sw.c:28
        RG_buffer_2 = RG_buffer_1; // ../../ave8_sw.c:28
        RG_buffer_1 = RG_buffer; // ../../ave8_sw.c:28
        RG_buffer = in0.read().to_uint(); // ../../ave8_sw.c:32
    }
}
