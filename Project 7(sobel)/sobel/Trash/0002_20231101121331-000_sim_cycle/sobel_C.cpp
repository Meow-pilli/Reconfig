...
generated : Tue Oct 31 17:12:21 2023
options : -EE -input=file:cycle -compare=cycle -dump=VCD -dump_signal=PORT -org_type=design -enum_int=NO -out_dir=. -file cmscgen_file.sobel.txt 
checksum : 00006f85f2b896d6bf3eda391a506b2b7ad84d7d69f9ea8e
...
sobel_test::trace_dump()
{
    ...
    Cysim_if_input_row_a00 >> std::hex;
    ...
    Cysim_if_input_row_a01 >> std::hex;
    ...
    Cysim_if_input_row_a02 >> std::hex;
...
sobel_test::log_file_out(ostream &Cysim_param_os, Cysim_int64 Cysim_param_cycle)
{
    ...
    if(!(Cysim_flags_i_input_row_a00 & 1)){
        cysim::printHex(Cysim_param_os << "input\tinput_row_a00\t", input_row_a00.read()) << '\n';
    }
    if(!(Cysim_flags_i_input_row_a01 & 1)){
        cysim::printHex(Cysim_param_os << "input\tinput_row_a01\t", input_row_a01.read()) << '\n';
    }
    if(!(Cysim_flags_i_input_row_a02 & 1)){
        cysim::printHex(Cysim_param_os << "input\tinput_row_a02\t", input_row_a02.read()) << '\n';
    }
    cysim::printHex(Cysim_param_os << "output\tsobel_ret\t", sobel_ret.read()) << '\n';
