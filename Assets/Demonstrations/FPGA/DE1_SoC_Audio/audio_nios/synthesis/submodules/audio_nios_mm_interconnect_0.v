...
module audio_nios_mm_interconnect_0 (
	...
	wire  [102:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> onchip_memory2_s1_agent:cp_data
	wire          cmd_mux_005_src_ready;                                                              // onchip_memory2_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire    [7:0] cmd_mux_005_src_channel;                                                            // cmd_mux_005:src_channel -> onchip_memory2_s1_agent:cp_channel
	...
	wire  [102:0] onchip_memory2_s1_agent_rp_data;                                                    // onchip_memory2_s1_agent:rp_data -> router_007:sink_data
	...
	wire   [84:0] sdram_s1_agent_rp_data;                                                             // sdram_s1_agent:rp_data -> router_008:sink_data
	...
	wire   [84:0] router_008_src_data;                                                                // router_008:src_data -> sdram_s1_rsp_width_adapter:in_data
	...
	wire  [102:0] sdram_s1_rsp_width_adapter_src_data;                                                // sdram_s1_rsp_width_adapter:out_data -> rsp_demux_006:sink_data
	...
	wire  [102:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> sdram_s1_cmd_width_adapter:in_data
	...
	audio_nios_mm_interconnect_0_router_005 router_007 (
	...
	audio_nios_mm_interconnect_0_cmd_mux_003 cmd_mux_005 (
		.clk                 (pll_outclk0_clk),                             //       clk.clk
		.reset               (jtag_uart_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	audio_nios_mm_interconnect_0_rsp_demux_003 rsp_demux_005 (
		.clk                (pll_outclk0_clk),                             //       clk.clk
		.reset              (jtag_uart_reset_reset_bridge_in_reset_reset), // clk_reset.reset
