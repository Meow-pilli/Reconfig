...
checksum : 0000394771d0a9d06b1d400ee15028a0c8ad5ece32f25326
...
struct ave8: CysimBase_ave8
{
    ...
    Cysim_uint32 RG_07; // BITWIDTH:10
    sc_signal<Cysim_uint32 > RG_08; // BITWIDTH:9
    sc_signal<Cysim_uint32 > RG_buffer_7; // BITWIDTH:8
    sc_signal<Cysim_uint32 > RG_10; // BITWIDTH:11
    sc_signal<Cysim_uint32 > ave8_ret_r; // BITWIDTH:8
    sc_signal<Cysim_uint32 > Cysim_State;


    // register update
    void CysimRegUpdate_CLOCK_pos(void);
