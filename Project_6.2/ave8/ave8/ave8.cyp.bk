...
<root version="6.1.5" >
  <object path="ave8" type="Project" name="ave8" >
    <properties>
      ...
      <property type="string" value="2023/10/17 14:26:30.000" name="bl::timestamp" />
      <property type="string" value="2023/10/17 14:23:34.000" name="bp::timestamp" />
      ...
      <property type="string" value="2023/10/17 14:23:34.000" name="co::timestamp" />
      <property type="string" value="2023/10/17 14:23:34.000" name="cp::timestamp" />
      ...
      <property type="string" value="2023/10/17 14:26:30.000" name="fl::timestamp" />
      <property type="string" value="" name="generateFileName" />
      <property type="string" value="bdlpars" name="lang" />
      <property type="string" value="2023/10/17 15:26:15.000" name="lastModified" />
      <property type="string" value="" name="librarySelect" />
      <property type="string" value="qts" name="logicSynthesizer" />
      <property type="string" value="2023/10/17 14:23:34.000" name="ls::timestamp" />
      <property type="string" value="FC31" name="package" />
      <property type="string" value="2023/10/17 14:23:35.000" name="pb::timestamp" />
      <property type="string" value="2023/10/17 14:23:35.000" name="pf::timestamp" />
      <property type="string" value="2023/10/17 14:23:34.000" name="rf::timestamp" />
      <property type="string" value="2023/10/17 14:23:34.000" name="sp::timestamp" />
        ...
        <objects>
          <object path="ave8_sw.c" type="FileSource" name="ave8_sw.c" >
            <properties>
              ...
              <property type="string" value="2023/10/17 14:30:44.000" name="IffCreateStateTimestamp" />
              <property type="string" value="ave8_sw.c.dir/ave8/ave8.IFF" name="OutputFileNames" />
              <property type="string" value="2023/10/17 14:30:34.000" name="bp::timestamp" />
              <property type="string" value="2023/10/17 14:30:34.000" name="cp::timestamp" />
              <property type="int" value="8" name="extraInfo" />
              <property type="string" value="2023/10/17 14:30:45.000" name="lastBuilt" />
              <property type="string" value="2023/10/17 14:30:34.000" name="sp::timestamp" />
            </properties>
            <objects>
              <object path="ave8_sw.c.dir/ave8/ave8.IFF" type="subitem" name="ave8" >
                <properties>
                  ...
                  <property type="string" value="2023/10/17 14:30:45.000" name="bt::timestamp" />
                  ...
                  <property type="string" value="2023/10/17 14:30:45.000" name="ls::timestamp" />
                  <property type="string" value="2023/10/17 14:30:45.000" name="vh::timestamp" />
                  <property type="string" value="2023/10/17 14:30:45.000" name="vl::timestamp" />
                </properties>
              </object>
            </objects>
          </object>
      ...
      <object path="logic_synthesis_work" type="Dir4" name="logic_synthesis_work" >
        <objects>
          <object path="ave8" type="LogicSyn" name="ave8" >
            <properties>
              <property type="string" value="2023/10/17 15:05:15.000" name="created" />
            </properties>
            <objects>
              <object path="ave8_E.v" type="File3" name="ave8_E.v" />
      ...
      <object path="simulation_work" type="Dir3" name="simulation_work" >
        <objects>
          <object path="ave8_cycle" type="Scenario" name="ave8_cycle" >
            <properties>
              <property type="string" value="2023/10/17 15:13:54.000" name="created" />
              <property type="string" value="2023/10/17 15:13:54.000" name="do::timestamp" />
              ...
              <property type="string" value="2023/10/17 15:26:15.000" name="mk::timestamp" />
              <property type="string" value="10" name="sc::DataRadix" />
              <property type="string" value="VCD" name="sc::Dump" />
              <property type="string" value="user" name="sc::Input" />
              <property type="string" value="tb_manual_ave8" name="sc::Tbfile" />
              <property type="string" value="2023/10/17 15:26:15.000" name="sc::timestamp" />
              <property type="string" value="2023/10/17 15:23:42.000" name="se::timestamp" />
              ...
              <property type="string" value="2023/10/17 15:23:42.000" name="ss::timestamp" />
            </properties>
          </object>
        </objects>
      </object>
