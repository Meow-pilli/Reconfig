...
then
	...
	GCCFILE=gcc-linaro-7.5.0-2019.12-i686-mingw32_arm-linux-gnueabihf
else
...
#	echo Linaro toolchain tarball found, skipping download
	...
	wget http://releases.linaro.org/components/toolchain/binaries/7.5-2019.12/arm-linux-gnueabihf/${GCCFILE}.tar.xz -O ${GCCFILE}.tar.xz
