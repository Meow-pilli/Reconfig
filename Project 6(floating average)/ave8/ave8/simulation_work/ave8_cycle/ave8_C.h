...
checksum : 00003e2c27807fe8c59ed3d9d83b346d2a79939725b885cc
...
SC_MODULE ( CysimBase_ave8 ), CysimBase_
{
    ...
    sc_in<sc_uint<1> > enable; // BITWIDTH:1
...
struct ave8: CysimBase_ave8
{
    ...
    Cysim_uint32 RG_buffer_7; // BITWIDTH:8
...
class ave8_test : public sc_module {
 public:
    ...
    ifstream Cysim_if_enable;
    int Cysim_flags_i_enable;
