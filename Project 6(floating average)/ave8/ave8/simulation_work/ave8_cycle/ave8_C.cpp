...
generated : Sun Oct 29 20:09:46 2023
...
checksum : 000064c87dec230b0888d46017f4860fa72a54167d0ecc3f
timestamp_C : 20231029191224_25952_43913
...
CysimBase_ave8::CysimBase_ave8(const sc_module_name& name_):
    in0("in0"), enable("enable"), ave8_ret("ave8_ret"), CLOCK("CLOCK"), 
    RESET("RESET") {}
...
ave8::CysimRegUpdate_CLOCK_pos_RESET_pos_Async()
{
    ...
    Cysim_uint32 M_17; // BITWIDTH:9
    Cysim_uint32 M_16; // BITWIDTH:9
    Cysim_uint32 M_15; // BITWIDTH:9
    Cysim_uint32 M_14; // BITWIDTH:9
    Cysim_uint32 CT_01; // BITWIDTH:1
    Cysim_uint32 M_121_t; // BITWIDTH:11
    Cysim_uint32 M_101_t; // BITWIDTH:10
    Cysim_uint32 sum1_t; // BITWIDTH:11
    Cysim_uint32 buffer_a06_t1; // BITWIDTH:8
    Cysim_uint32 buffer_a05_t1; // BITWIDTH:8
    Cysim_uint32 buffer_a07_t1; // BITWIDTH:8
    Cysim_uint32 buffer_a02_t1; // BITWIDTH:8
    Cysim_uint32 buffer_a01_t1; // BITWIDTH:8
    Cysim_uint32 buffer_a04_t1; // BITWIDTH:8
    Cysim_uint32 buffer_a03_t1; // BITWIDTH:8
    Cysim_uint32 buffer_a00_t1; // BITWIDTH:8
    if(RESET.read()) {
        RG_buffer = 0x0U;
        RG_buffer_1 = 0x0U;
        RG_buffer_2 = 0x0U;
        ...
        CT_01 = ((~enable.read().to_uint()) & CYSIM_MASK32(1)); // ../../ave8_sw.c:25 OPR_OUT_WIDTH:1
        if(CT_01){ // ../../ave8_sw.c:25
            buffer_a06_t1 = RG_buffer_5; // ../../ave8_sw.c:28
            buffer_a00_t1 = in0.read().to_uint(); // ../../ave8_sw.c:32
            buffer_a03_t1 = RG_buffer_2; // ../../ave8_sw.c:28
            buffer_a04_t1 = RG_buffer_3; // ../../ave8_sw.c:28
            buffer_a01_t1 = RG_buffer; // ../../ave8_sw.c:28
            buffer_a02_t1 = RG_buffer_1; // ../../ave8_sw.c:28
            buffer_a07_t1 = RG_buffer_6; // ../../ave8_sw.c:28
            buffer_a05_t1 = RG_buffer_4; // ../../ave8_sw.c:28
        } else {
        ...
        M_14 = (CYSIM_MASK32(9) & (buffer_a05_t1 + buffer_a06_t1)); // ../../ave8_sw.c:39 OPR_OUT_WIDTH:9
        M_16 = (CYSIM_MASK32(9) & (buffer_a03_t1 + buffer_a04_t1)); // ../../ave8_sw.c:39 OPR_OUT_WIDTH:9
        M_17 = (CYSIM_MASK32(9) & (buffer_a01_t1 + buffer_a02_t1)); // ../../ave8_sw.c:39 OPR_OUT_WIDTH:9
        M_101_t = (CYSIM_MASK32(10) & (M_17 + M_16)); // ../../ave8_sw.c:39 OPR_OUT_WIDTH:10
        M_121_t = (CYSIM_MASK32(11) & (M_101_t + M_14)); // ../../ave8_sw.c:39 OPR_OUT_WIDTH:11
        M_15 = (CYSIM_MASK32(9) & (buffer_a07_t1 + buffer_a00_t1)); // ../../ave8_sw.c:35,39 OPR_OUT_WIDTH:9
        sum1_t = (CYSIM_MASK32(11) & (M_121_t + M_15)); // ../../ave8_sw.c:35,39 OPR_OUT_WIDTH:11
...
ave8::register_dump(sc_trace_file* Cysim_tf, const std::string& Cysim_param_path)
{
    ...
    sc_trace(Cysim_tf, enable, Cysim_param_path + "enable");
...
ave8_test::trace_dump()
{
    ...
    Cysim_if_enable.open("enable.clv");
    Cysim_if_enable >> std::hex;
    if (Cysim_if_enable.is_open()) {
        if ((Cysim_if_enable >> std::ws).eof()) {
            Cysim_flags_i_enable = 1;
        } else {
            Cysim_flags_i_enable = (1<<1);
            Cysim_finished_wait ++;
        }
    } else {
        std::cerr << "Cannot open file(enable.clv)" << std::endl;
        Cysim_flags_i_enable = 1;
    }
...
ave8_test::input_method()
{
    ...
    {
        sc_uint<1> Cysim_tmp;
        input_dataSC<1>(Cysim_tmp, Cysim_if_enable, Cysim_flags_i_enable, enable.read());
        if(!(Cysim_flags_i_enable & 1)){
            enable = Cysim_tmp;
        }
    }
}
...
ave8_test::log_file_out(ostream &Cysim_param_os, Cysim_int64 Cysim_param_cycle)
{
    ...
    if(!(Cysim_flags_i_enable & 1)){
        cysim::printHex(Cysim_param_os << "input\tenable\t", enable.read()) << '\n';
    }
...
sc_main(int argc, char *argv[])
{
    ...
    Cysim_testunit_ave8.enable(enable);
